...
sources = main.cpp application.cpp voxel_generator.cpp voxel_shader_program_stupid_cs.cpp voxel_shader_program_render.cpp static_mesh.cpp str_event.cpp static_shader_program.cpp shader_program.cpp world_pipeline.cpp input_handler.cpp texture.cpp
