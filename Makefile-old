...
sources = main.cpp application.cpp input_handler.cpp shader_program.cpp static_mesh.cpp static_shader_program.cpp world_pipeline.cpp game_state.cpp str_event.cpp str_engine_cpu.cpp
